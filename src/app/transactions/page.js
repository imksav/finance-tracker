...
import FavoriteIcon from "@mui/icons-material/Favorite"; // You can also use Face3Icon if you prefer an avatar
...
export default function Transactions() {
  ...
  const getTypeStyles = (typeName) => {
    ...
    if (typeName === "Wife")
      return { color: "#e91e63", icon: <FavoriteIcon />, bg: "#fce4ec" };
